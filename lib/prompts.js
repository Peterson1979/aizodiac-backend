...

{
  ...
  "Current Period (Planetary Transits – Daily)": "[Give a short forecast for TODAY based on current planetary movements relevant to the chart]",
  "Current Period (Planetary Transits – Weekly)": "[Give a short forecast for THIS WEEK based on current planetary movements relevant to the chart]",
  "Current Period (Planetary Transits – Monthly)": "[Give a short forecast for THIS MONTH based on current planetary movements relevant to the chart]",
  "Current Period (Planetary Transits – Yearly)": "[Give a short forecast for THIS YEAR based on current planetary movements relevant to the chart]",
