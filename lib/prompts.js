...
`,
  ...
  personal_horoscope: `
${BASE_RULES}
Natal chart forecast for Sun: {{sunSign}}, Moon: {{moonSign}}, Ascendant: {{risingSign}}.
Elements: Fire {{firePercent}}%, Earth {{earthPercent}}%, Air {{airPercent}}%, Water {{waterPercent}}%.
Translate sign names for Sun, Moon, Ascendant to {{language}}.
...
`,
  ...
  numerology: `
${BASE_RULES}
Numerology interpretation for precomputed numbers: Life Path {{lifePathNumber}}, Expression {{expressionNumber}}, Soul Urge {{soulUrgeNumber}}, Personality {{personalityNumber}}, Birthday {{birthdayNumber}}.
