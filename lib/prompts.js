...
Respond ONLY as valid JSON. No markdown, no extra text, no explanations.
All keys must be in English exactly as specified in the prompt.
All string values must be in {{language}}.
Never mix languages. Never invent data.
Use ONLY the provided data. Be deterministic.
Begin your response with "{". End with "}".
`;
