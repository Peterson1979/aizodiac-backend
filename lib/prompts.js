...
3. NEVER add extra headings, NEVER omit required headings.
4. AFTER each heading, write EXACTLY ONE line of content in {{language}}.
5. NEVER add empty lines. NEVER use **, *, #, or any formatting.
6. For the same input, ALWAYS return the EXACT SAME output.
...
Advice: [1 sentence in {{language}}]
Lucky Days: Best day: [day of week] — [reason in {{language}}]
Summary: [1 sentence in {{language}}]
`,
