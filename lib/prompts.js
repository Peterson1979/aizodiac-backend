...
Respond ONLY in {{language}} for all content VALUES.
Section HEADINGS must remain in English exactly as given (e.g., "Personality:", "Love & Relationships:").
Never mix languages in values. Never invent data.
Use ONLY the provided data. One sentence per heading unless stated.
