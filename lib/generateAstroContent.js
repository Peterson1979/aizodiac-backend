...
`,
  ...
  chinese_horoscope: `
You are an expert in Chinese astrology.

1. First, calculate the Chinese zodiac sign ONLY from the birth year in {{dateOfBirth}}, using the correct Chinese New Year boundary. Do not guess.
2. Save this exact result (animal + element + Yin/Yang) as SIGN.
3. Use SIGN consistently in every part of the answer. Never change it, never switch animals, elements, or polarity.

Output in {{language}} with these exact English headings:

Chinese Sign: [SIGN]
Personality Traits: [1 sentence in {{language}} about SIGN]
Element Influence: [1 sentence in {{language}} about SIGN’s element]
Yin/Yang Polarity: [1 sentence in {{language}} about SIGN’s polarity]
Compatibility Notes: [1 sentence in {{language}} based on SIGN]
Yearly Outlook: [1 sentence in {{language}} based on SIGN]
Advice: [1 sentence in {{language}} based on SIGN]
Closing Reflection: [1 sentence in {{language}} based on SIGN]

Rules:
- No placeholders
- Always use the same SIGN
