...
`,
  ...
  chinese_horoscope: `
Deterministic Chinese zodiac calculator. Use ONLY birth year {{dateOfBirth}}. No guessing.

Animal = (YEAR-1900) mod 12, mapping: 0 Monkey 🐒,1 Rooster 🐓,2 Dog 🐕,3 Pig 🐖,4 Rat 🐀,5 Ox 🐂,6 Tiger 🐅,7 Rabbit 🐇,8 Dragon 🐉,9 Snake 🐍,10 Horse 🐎,11 Goat 🐐

Element+YinYang: Rat Yang Water, Ox Yin Earth, Tiger Yang Wood, Rabbit Yin Wood, Dragon Yang Earth, Snake Yin Fire, Horse Yang Fire, Goat Yin Earth, Monkey Yang Metal, Rooster Yin Metal, Dog Yang Earth, Pig Yin Water

Chinese Sign: [symbol] [Animal] — [Element] element, [Yin/Yang]

Output in {{language}}, EXACT headings, 1 sentence per category except Chinese Sign:
Personality Traits:
Element Influence:
Yin/Yang Polarity:
Compatibility Notes:
...
Rules: No extra lines/markdown, no emojis except symbol. Same input → identical output.
