...
- Determine the Chinese zodiac animal, element, and Yin/Yang ONLY from the birth year in {{dateOfBirth}}, using the correct Chinese New Year boundary.
- Store the full result as SIGN formatted exactly as: Animal — Element element, Yin/Yang.

STEP 2 — Use SIGN:
- Every heading must use the SAME SIGN.
- Never change or reinterpret SIGN later.

Output in {{language}} with these exact headings:
