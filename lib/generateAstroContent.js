...
The user's Chinese zodiac sign is:
...
Rules:
- NEVER calculate or guess the zodiac sign — it is given as {{SIGN}}
- NEVER use placeholders like "(...)" or "1 sentence in English"
- ALWAYS produce exactly 1 sentence per category
- For the same input, ALWAYS return the EXACT SAME output
- No markdown
- No empty lines
- Headings in English
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const filledPrompt = fillTemplate(finalPromptTemplate, {
