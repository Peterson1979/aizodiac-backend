  ...
  try {
    ...
    if (type === "chinese_horoscope" && data.dateOfBirth) {
      try {
        ...
        finalData.SIGN = zodiac.signLine;
      } catch (e) {
    ...
    const commonFields = [ "zodiacSign", "dateOfBirth", "timeOfBirth", "placeOfBirth", "name", "fullName", "question", "specificDate", "period", "timeRange", "focusArea", "SIGN" ];
