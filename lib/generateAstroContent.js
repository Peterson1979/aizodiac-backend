...
Generate a concise forecast strictly for this time period:
- If "daily", focus ONLY on today
- If "weekly", cover the upcoming 7 days
- If "monthly", cover the entire current month
- If "yearly", cover the entire current year
- If "specificDate" is provided, focus EXCLUSIVELY on that date
