...
const ANIMALS_HU = ["Majom", "Tyúk", "Kutya", "Disznó", "Egér", "Bika", "Tigris", "Nyúl", "Sárkány", "Kígyó", "Ló", "Bárány"];
const EMOJIS = ["🐒", "🐓", "🐕", "🐖", "🐀", "🐂", "🐅", "🐇", "🐉", "🐍", "🐎", "🐐"];
const ELEMENTS_HU = { "Wood": "Fa", "Fire": "Tűz", "Earth": "Föld", "Metal": "Fém", "Water": "Víz" };
...
export function getChineseZodiac_FULL(dateStr) {
  ...
  return { symbol, animal: animalHu, element: elementHu, yinYang };
}