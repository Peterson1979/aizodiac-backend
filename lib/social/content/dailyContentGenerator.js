  ...
  properties: {
    ...
    slides: {
      ...
      items: {
        ...
        required: ["type", "sign", "headline", "body"],
...
4. Exactly 5 slides structured as follows (every slide object MUST include all 4 keys: "type", "sign", "headline", "body"):
   - Slide 1 (type: "title"): Catchy hook headline (under 60 chars). Set "sign": null, "body": null.
   - Slide 2 (type: "sign" or "insight"): First spotlighted zodiac sign or core insight. If type is "sign", "sign" must be a valid Western sign (e.g. "Taurus"); if type is "insight", set "sign": null. Headline must be the sign or keyword. Body should be 2-3 compelling sentences (under 180 chars).
   ...
   - Slide 5 (type: "cta"): Call to action. Set "sign": null. Headline must be "Discover more with AI Zodiac" (or very similar). Body must state "Free on Google Play".
