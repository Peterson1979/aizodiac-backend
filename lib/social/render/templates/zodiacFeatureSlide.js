...
/**
 * Generates the minimal SVG vector overlay for the Zodiac Feature Slide.
  ...
  return `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${CANVAS_WIDTH} ${CANVAS_HEIGHT}" width="${CANVAS_WIDTH}" height="${CANVAS_HEIGHT}">
      ...
      <g transform="translate(540, 285)">
        <circle cx="0" cy="0" r="64" fill="#141733" fill-opacity="0.90" stroke="${accent.color}" stroke-width="2" />
      </g>
