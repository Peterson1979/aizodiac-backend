...
export const LAYOUT_ZONES = Object.freeze({
  ...
  COVER: {
    ...
    DECORATION: { top: 340, bottom: 440, height: 100 },
    TITLE: { top: 470, bottom: 920, height: 450, maxWidth: 820 },
    MARKERS: { top: 960, bottom: 1020, height: 60 },
    FOOTER: { top: 1140, bottom: 1240, height: 100 },
  },

  FEATURE: {
    EMBLEM: { top: 200, bottom: 370, height: 170 },
  ...
  CTA: {
    EMBLEM: { top: 200, bottom: 360, height: 160 },
...
/**
 * Shared Cosmic SVG Background Vector Generator (Zero SVG text elements).
 * @returns {string}
 */
...
/**
 * Renders a deterministic vector zodiac emblem disc background (No SVG text elements).
 * @param {object} params
...
export function renderZodiacEmblemSvg({ sign, cx = 540, cy = 285, radius = 64 }) {
  ...
  return `
    ...
    <g transform="translate(${cx}, ${cy})">
      ...
      <!-- Inner Card Disc -->
      <circle cx="0" cy="0" r="${radius}" fill="#141733" stroke="${accentColor}" stroke-width="2" filter="url(#glowSubtle)" />

      <!-- Cardinal Compass Accents -->
