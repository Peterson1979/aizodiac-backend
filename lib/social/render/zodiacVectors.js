...
export const CELESTIAL_STAR_PATH = `
  <path d="M0 -22 L4 -6 L20 -20 L6 -4 L22 0 L6 4 L20 20 L4 6 L0 22 L-4 6 L-20 20 L-6 4 L-22 0 L-6 -4 L-20 -20 L-4 -6 Z" />
`.trim();

/**
 * Returns deterministic SVG markup for a zodiac symbol or celestial emblem.
 * @param {string} sign - Zodiac sign name or celestial topic
...
export function getZodiacSvgGlyph(sign, color = "#fbbf24", strokeWidth = 3.5) {
  ...
  const pathMarkup = ZODIAC_SVG_PATHS[capitalized] || CELESTIAL_STAR_PATH;
